...
export const initialData: SeedData = {
    ...
    products: [
        ...
        {
            description: "Inspired by the worldâ€™s most unlimited resource, the Let the Sun Shine Tee highlights our fully integrated home solar and storage system. Designed for fit, comfort and style, the tee features a sunset graphic along with our Tesla wordmark on the front and our signature T logo printed above 'Solar Roof' on the back. Made from 100% Peruvian cotton.",
            images: [
        ...
        },
        {
            ...
            type: 'shirts',
            tags: ['shirt'],
            title: "Menâ€™s 3D Small Wordmark Tee",
        },
        {
            description: "Designed to celebrate Tesla's incredible performance mode, the Plaid Mode Tee features great fit, comfort and style. Made from 100% cotton, it's the next best thing to riding shotgun at the NÃ¼rburgring.",
            images: [
        ...
        },
        {
            ...
            type: 'shirts',
            tags: ['shirt'],
            title: "Menâ€™s Cybertruck Bulletproof Tee",
        },
        {
        ...
        {
            description: "Designed for fit, comfort and style, the limited edition S3XY Tee is made from 100% cotton with a 3D silicone-printed â€œS3XYâ€ logo across the chest. Made in Peru. Available in black.",
            images: [
